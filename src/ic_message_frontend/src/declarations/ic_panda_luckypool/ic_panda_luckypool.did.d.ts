...
export type Result = { 'Ok': PrizeOutput } | { 'Err': string }
export type Result_1 = { 'Ok': null } | { 'Err': string }
export type Result_10 = { 'Ok': bigint } | { 'Err': string }
export type Result_11 = { 'Ok': [] | [NameOutput] } | { 'Err': null }
export type Result_12 = { 'Ok': Principal } | { 'Err': string }
export type Result_13 = { 'Ok': NameOutput } | { 'Err': string }
export type Result_14 = { 'Ok': State } | { 'Err': null }
export type Result_15 = { 'Ok': bigint } | { 'Err': string }
export type Result_16 = { 'Ok': Principal } | { 'Err': null }
export type Result_2 = { 'Ok': AirdropStateOutput } | { 'Err': string }
export type Result_3 = { 'Ok': AirdropStateOutput } | { 'Err': null }
export type Result_4 = { 'Ok': Airdrops108Output } | { 'Err': null }
export type Result_5 = { 'Ok': CaptchaOutput } | { 'Err': string }
export type Result_6 = { 'Ok': ClaimPrizeOutput } | { 'Err': string }
export type Result_7 = { 'Ok': LuckyDrawOutput } | { 'Err': string }
export type Result_8 = { 'Ok': string } | { 'Err': string }
...
export interface _SERVICE {
  ...
  'airdrop_logs': ActorMethod<[[] | [bigint], [] | [bigint]], Array<AirdropLog>>
  ...
  'manager_remove_notifications': ActorMethod<[Uint8Array | number[]], Result_1>
