...
export type Result_1 = { 'Ok': CanisterStatusResult } | { 'Err': string }
export type Result_2 = { 'Ok': ProfileInfo } | { 'Err': string }
export type Result_3 = { 'Ok': StateInfo } | { 'Err': string }
export type Result_4 = { 'Ok': UploadImageOutput } | { 'Err': string }
