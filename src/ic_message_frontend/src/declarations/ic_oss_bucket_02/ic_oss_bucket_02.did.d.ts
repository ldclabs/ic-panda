...
export type Result_1 = { 'Ok': Uint32Array | number[] } | { 'Err': string }
export type Result_10 = { 'Ok': Array<FileInfo> } | { 'Err': string }
export type Result_11 = { 'Ok': Array<FolderInfo> } | { 'Err': string }
export type Result_12 = { 'Ok': UpdateFileOutput } | { 'Err': string }
export type Result_13 = { 'Ok': UpdateFileChunkOutput } | { 'Err': string }
export type Result_14 = { 'Ok': string } | { 'Err': string }
export type Result_2 = { 'Ok': CreateFileOutput } | { 'Err': string }
export type Result_3 = { 'Ok': boolean } | { 'Err': string }
export type Result_4 = { 'Ok': BucketInfo } | { 'Err': string }
export type Result_5 = { 'Ok': CanisterStatusResponse } | { 'Err': string }
export type Result_6 = { 'Ok': Array<FolderName> } | { 'Err': string }
export type Result_7 =
  { 'Ok': Array<[number, Uint8Array | number[]]> } | { 'Err': string }
export type Result_8 = { 'Ok': FileInfo } | { 'Err': string }
export type Result_9 = { 'Ok': FolderInfo } | { 'Err': string }
...
export interface _SERVICE {
  ...
  'delete_folder': ActorMethod<[number, [] | [Uint8Array | number[]]], Result_3>
  ...
  'get_file_chunks': ActorMethod<
    ...
    Result_7
  >
  'get_file_info': ActorMethod<[number, [] | [Uint8Array | number[]]], Result_8>
  ...
  'list_folders': ActorMethod<
    ...
    Result_11
  >
  'move_file': ActorMethod<[MoveInput, [] | [Uint8Array | number[]]], Result_12>
