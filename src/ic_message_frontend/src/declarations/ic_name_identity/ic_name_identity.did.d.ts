...
export type Result = { 'Ok': Array<Delegator> } | { 'Err': string }
export type Result_1 = { 'Ok': null } | { 'Err': string }
export type Result_2 = { 'Ok': SignedDelegation } | { 'Err': string }
export type Result_3 = { 'Ok': Array<NameAccount> } | { 'Err': string }
export type Result_4 = { 'Ok': Principal } | { 'Err': string }
export type Result_5 = { 'Ok': State } | { 'Err': string }
export type Result_6 = { 'Ok': SignInResponse } | { 'Err': string }
...
export interface _SERVICE {
  ...
  'sign_in': ActorMethod<
    ...
    Result_6
  >
  'validate_admin_reset_name': ActorMethod<[string, Array<Principal>], Result_7>
