...
export type CanisterKind = { 'OssBucket': null } | { 'OssCluster': null }
...
export type ChainArgs = { 'Upgrade': UpgradeArgs } | { 'Init': InitArgs }
...
export type Result = { 'Ok': AddMessageOutput } | { 'Err': string }
export type Result_1 = { 'Ok': null } | { 'Err': string }
export type Result_10 = { 'Ok': Uint32Array | number[] } | { 'Err': string }
export type Result_11 = { 'Ok': [bigint, [] | [Message]] } | { 'Err': string }
export type Result_12 = { 'Ok': ChannelSetting } | { 'Err': string }
export type Result_13 = { 'Ok': UploadFileOutput } | { 'Err': string }
export type Result_14 = { 'Ok': string } | { 'Err': string }
export type Result_2 = { 'Ok': ChannelInfo } | { 'Err': string }
export type Result_3 = { 'Ok': Array<ChannelBasicInfo> } | { 'Err': string }
export type Result_4 = { 'Ok': DownloadFilesToken } | { 'Err': string }
export type Result_5 = { 'Ok': CanisterStatusResult } | { 'Err': string }
export type Result_6 = { 'Ok': [] | [ChannelInfo] } | { 'Err': string }
export type Result_7 = { 'Ok': Message } | { 'Err': string }
export type Result_8 = { 'Ok': StateInfo } | { 'Err': string }
export type Result_9 = { 'Ok': Array<Message> } | { 'Err': string }
...
export interface TruncateMessageInput {
  'to': number
  'channel': number
}
...
export interface _SERVICE {
  ...
  'list_messages': ActorMethod<[number, [] | [number], [] | [number]], Result_9>
  ...
  'validate2_admin_remove_managers': ActorMethod<[Array<Principal>], Result_14>
