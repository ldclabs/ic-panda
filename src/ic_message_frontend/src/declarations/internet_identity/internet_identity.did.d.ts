...
export type AuthnMethod =
  { 'PubKey': PublicKeyAuthn } | { 'WebAuthn': WebAuthn }
 ...
 */
export type AuthnMethodProtection =
  { 'Protected': null } | { 'Unprotected': null }
export type AuthnMethodPurpose =
  { 'Recovery': null } | { 'Authentication': null }
