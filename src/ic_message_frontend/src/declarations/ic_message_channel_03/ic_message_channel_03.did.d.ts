...
export type Result_10 = { 'Ok': ChannelSetting } | { 'Err': string }
export type Result_2 = { 'Ok': ChannelInfo } | { 'Err': string }
export type Result_3 = { 'Ok': Array<ChannelBasicInfo> } | { 'Err': string }
export type Result_4 = { 'Ok': CanisterStatusResponse } | { 'Err': string }
export type Result_5 = { 'Ok': [] | [ChannelInfo] } | { 'Err': string }
export type Result_6 = { 'Ok': Message } | { 'Err': string }
export type Result_7 = { 'Ok': StateInfo } | { 'Err': string }
export type Result_8 = { 'Ok': Array<Message> } | { 'Err': string }
export type Result_9 = { 'Ok': [bigint, [] | [Message]] } | { 'Err': string }
...
export interface _SERVICE {
  ...
  'list_messages': ActorMethod<[number, [] | [number], [] | [number]], Result_8>
