...
export type InstallArgs = { 'Upgrade': UpgradeArgs } | { 'Init': InitArgs }
...
export type Result_1 = { 'Ok': NamespaceInfo } | { 'Err': string }
export type Result_10 =
  { 'Ok': Array<[Principal, Uint8Array | number[]]> } | { 'Err': string }
export type Result_11 = { 'Ok': SignInResponse } | { 'Err': string }
export type Result_12 = { 'Ok': bigint } | { 'Err': string }
export type Result_13 = { 'Ok': CreateSettingOutput } | { 'Err': string }
export type Result_14 = { 'Ok': SettingInfo } | { 'Err': string }
export type Result_15 = { 'Ok': SettingArchivedPayload } | { 'Err': string }
export type Result_16 = { 'Ok': StateInfo } | { 'Err': string }
export type Result_17 = { 'Ok': string } | { 'Err': string }
export type Result_2 = { 'Ok': Array<NamespaceInfo> } | { 'Err': string }
export type Result_3 = { 'Ok': ECDHOutput } | { 'Err': string }
export type Result_4 = { 'Ok': PublicKeyOutput } | { 'Err': string }
export type Result_5 = { 'Ok': Uint8Array | number[] } | { 'Err': string }
export type Result_6 = { 'Ok': SignedDelegation } | { 'Err': string }
export type Result_7 = { 'Ok': Array<Principal> } | { 'Err': string }
export type Result_8 = { 'Ok': Principal } | { 'Err': string }
...
export interface _SERVICE {
  ...
  'admin_list_namespace': ActorMethod<[[] | [string], [] | [number]], Result_2>
  ...
  'namespace_remove_delegator': ActorMethod<[NamespaceDelegatorsInput], Result>
  ...
  'setting_remove_readers': ActorMethod<[SettingPath, Array<Principal>], Result>
  ...
  'validate2_admin_remove_allowed_apis': ActorMethod<[Array<string>], Result_17>
  'validate2_admin_remove_auditors': ActorMethod<[Array<Principal>], Result_17>
  'validate2_admin_remove_managers': ActorMethod<[Array<Principal>], Result_17>
