...
export type CanisterKind =
  { 'Cose': null } | { 'Channel': null } | { 'Profile': null }
...
export type Result_1 = { 'Ok': Array<UserInfo> } | { 'Err': string }
export type Result_2 = { 'Ok': ChannelInfo } | { 'Err': string }
export type Result_3 = { 'Ok': UserInfo } | { 'Err': string }
export type Result_4 = { 'Ok': CanisterStatusResult } | { 'Err': string }
export type Result_5 = { 'Ok': StateInfo } | { 'Err': string }
export type Result_6 = { 'Ok': Uint8Array | number[] } | { 'Err': string }
...
export interface _SERVICE {
  ...
  'validate_admin_add_canister': ActorMethod<[CanisterKind, Principal], Result>
