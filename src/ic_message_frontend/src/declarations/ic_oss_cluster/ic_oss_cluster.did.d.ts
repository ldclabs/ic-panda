...
export type Result_10 = { 'Ok': Array<[Principal, string]> } | { 'Err': string }
export type Result_11 = { 'Ok': string } | { 'Err': string }
export type Result_2 =
  { 'Ok': Array<Uint8Array | number[]> } | { 'Err': string }
export type Result_3 = { 'Ok': Principal } | { 'Err': string }
export type Result_4 = { 'Ok': bigint } | { 'Err': string }
export type Result_5 = { 'Ok': Array<BucketDeploymentInfo> } | { 'Err': string }
export type Result_6 = { 'Ok': WasmInfo } | { 'Err': string }
export type Result_7 = { 'Ok': Array<Principal> } | { 'Err': string }
export type Result_8 = { 'Ok': CanisterStatusResult } | { 'Err': string }
export type Result_9 = { 'Ok': ClusterInfo } | { 'Err': string }
...
export interface _SERVICE {
  ...
  'validate_admin_deploy_bucket': ActorMethod<
    ...
    Result_1
  >
  'validate_admin_remove_committers': ActorMethod<[Array<Principal>], Result_11>
