...
<div
  class="flex flex-col justify-center rounded-2xl bg-[#fff9e5] bg-[url('/_assets/images/prize-giveaway-bg.webp')] bg-[length:100%_auto] bg-no-repeat p-4"
>
  ...
  <footer class="m-auto mb-6">
    ...
    <ol class="list *:!mt-4 *:!rounded-xl *:bg-white *:px-4 *:py-2">
      <li>
        <span
          class="badge-icon variant-gradient-warning-error bg-gradient-to-br p-4 text-white"
          >1</span
        >
    ...
    <div class="mt-4 flex flex-col items-center">
      <button
        ...
        class="btn variant-gradient-warning-error m-auto mt-3 w-[320px] max-w-full bg-gradient-to-br font-medium text-white transition duration-700 ease-in-out md:btn-lg hover:scale-110 hover:shadow"
      >
        Claim a Prize
      </button>
    </div>
