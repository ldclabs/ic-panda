...
/**
 * Local stand-in for `TokenAmountV2` from `@dfinity/utils`, which was the last
 * thing keeping that package in the dependency tree. Same surface as the parts
 * we used: `fromUlps`, `fromString`, `fromNumber` and `toUlps`.
 */
