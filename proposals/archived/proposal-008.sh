    ...
    record {
        ...
        action = opt variant {
            TransferSnsTreasuryFunds = record {
                ...
                memo = null;
                amount_e8s = 4200000000000000 : nat64;
            }
        };
    }
