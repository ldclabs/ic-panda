    ...
    record {
        ...
        action = opt variant {
            TransferSnsTreasuryFunds = record {
                ...
                memo = null;
                amount_e8s = 5500000000000000 : nat64;
            }
        };
    }
