...
# ic-oss-cli -i debug/oss.pem cluster-add-wasm -c 5szpn-tiaaa-aaaaj-qncoq-cai --path .dfx/ic/github/ic_oss_bucket.wasm.gz --description "ic_oss_bucket v1.1.5" --ic
...
quill sns make-proposal --canister-ids-file ./sns_canister_ids.json --pem-file $PROPOSAL_PEM_FILE $PROPOSAL_NEURON_ID --proposal "(
    record {
        title = \"Execute admin_deploy_bucket() to update ic-oss-bucket WASM to vv1.1.5\";
        url = \"https://github.com/ldclabs/ic-oss/releases/tag/v1.1.5\";
