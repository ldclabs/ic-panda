...
quill sns make-proposal --canister-ids-file ./sns_canister_ids.json --pem-file $PROPOSAL_PEM_FILE $PROPOSAL_NEURON_ID --proposal '(
    record {
        title = "Add a generic function \"admin_add_canister\" to ic_message_channel service";
        ...
        action = opt variant {
            AddGenericNervousSystemFunction = record {
                ...
                description = opt "It is used to add more IC-OSS canisters to ic_message_channel service.";
