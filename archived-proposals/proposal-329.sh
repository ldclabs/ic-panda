...
POSITION_ID="24"    # The position ID you want to transfer. https://app.icpswap.com/info-tools/positions?pair=5fq4w-lyaaa-aaaag-qjqta-cai&principal=dwv6s-6aaaa-aaaaq-aacta-cai
